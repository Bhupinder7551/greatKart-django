...
def login(request):
    if request.method == 'POST':
        ...
        if user is not None:
            try:
                 cart= Cart.objects.get(cart_id=_cart_id(request)) #get the cart using cart_id pressent in the session
                 ...
                 if is_cart_item_exists:
                    ...
                    for item in cart_item:
                        ...
                        for item in cart_item:
                            ...
                            #  ex_var_list =[4,6,3,5]
                            #  bring the common variation from both
